 ...
 */
final class Version20220405193611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE service (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, published_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        )');
        ...
        , CONSTRAINT FK_5A8A6C8D5926566C FOREIGN KEY (illustration_id) REFERENCES illustration (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5A8A6C8D12469DE2 FOREIGN KEY (category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
